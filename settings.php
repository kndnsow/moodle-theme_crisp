...
if ($ADMIN->fulltree) {
    ...
    $setting = new admin_setting_configtext($name, $title, $description,'',PARAM_URL ); //'slidepic'
    ...
    $setting = new admin_setting_configtext($name3, $title3, $description3,'',PARAM_URL ); //'slidepic'
    $setting->set_updatedcallback('theme_reset_all_caches');
    $settings->add($setting);
